<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="ServiceValidation.aspx.vb" Inherits="Masterpage.ServiceValidation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               <h1 style="text-align: center; margin-top: 10px; margin-bottom: 20px;">Category Partner/Organization Service Validation Tables</h1>
    <nav class="navbar">
        <div class="container-fluid catesettingwidth">
            ...
            <div class="d-flex ms-auto">
                <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#AddService">Add</button>
                <div class="modal fade" id="AddService" tabindex="-1" aria-labelledby="Service" aria-hidden="true">
    ...
    <div class="container">
        <div class="row">
            <table class="table table-bordered table-secondary border-dark w-100">
                <thead>
                    <tr>
                        <th scope="col">Partner/Organization Services</th>
